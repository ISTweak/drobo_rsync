...
Check the [releases](https://github.com/ISTweak/rsync/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/ISTweak/rsync.git
cd rsync
./build.sh
```
